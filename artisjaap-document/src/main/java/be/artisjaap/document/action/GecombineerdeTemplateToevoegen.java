...
@Component
public class GecombineerdeTemplateToevoegen {
    @Autowired
    ...
    public void metNieuweCode(TemplateCodeNieuwTO templateCode){
        gecombineerdeTemplateCodeRepository.save(gecombineerdeTemplateCodeNieuwAssembler.assembleEntity(templateCode));
    }
}
